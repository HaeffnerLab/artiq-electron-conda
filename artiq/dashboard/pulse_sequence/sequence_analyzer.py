...
"""
This file defines a class called SequenceAnalyzer, whose purpose is to take raw information from the pulser server,
(namely, the information that SequenceAnalyzer gets initialized with: human_readable_ttl, human_readable_dds, and channels)
process it, and create a plot of it.

The DdsBox class is essentially a wrapper for a matplotlib.collections.PolyCollection object, which is created when plotting
...
class SequenceAnalyzer():
    ...
    def create_dds_plot(self, channel, axes, offset, scale=1.0):
        ...
        # Add a fill_between object to the axes for every pulse, and also create a DdsBox object to store in the present sequence_analyzer object.
